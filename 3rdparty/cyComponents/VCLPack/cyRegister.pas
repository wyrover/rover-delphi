...
uses
  ...
  {$ENDIF}
  cyPanel, cyAdvPanel, cyBevel, cyPaintBox, cyAdvPaintBox, cyLabel, cyHotLabel, cySpeedButton, cyAdvSpeedButton, cyBitBtn, cyAdvButton,
  cySkinButton, cySkinArea, cyLed, cyAdvLed, cySimpleGauge, cySplitter, cyAttract, cyColorMatrix, cyColorGrid, cyStatusBar, cyBook,
  cyPageControl, cyTabControl, cyStaticText, cyAdvStaticText, cyEdit, cyEditInteger, cyEditFloat, cyEditDate, cyEditTime,
