...
const
  ...
  procedure AdjustColumnsToContent(aDBGrid: DBGrids.TDBGrid; const incColumnWidth: Integer = 8);
...
begin
  ...
  AdjustClientColumn;  // RHR UpdateLayout
end;
...
(* // 2013-10-30 !!! BIG BUG : We can' t manipulate ScrollBars property here because it raise error sometimes !!!
